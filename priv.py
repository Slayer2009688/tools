#coded by GOJO BOOSTING SERVICE
#don't edit anything or it would cause an error
import requests
import re
import os
   ...
   \::::|::::|:|::\     /::|        \::|::::::|::/‘ '|::\    /::::|:::|::::::|::'|'          \::|::::::|::/‘ '
     \::|::::|:|::::\ /::::|          \|::::::|/‘   '|::::\/:::::/'\::|::::::|::/             \|::::::|/‘   '
       \|::::|/ \::::|::::/‘            ¯¯¯'      \::::|::::/    '\|::::::|/                 ¯¯¯'      
         ¯¯    '\::|::/'‚              ‘             \::|::/        ¯¯¯‘                   ‘           
                   \|/'‚                           ‘    \|/
                 {white} https://amoreivy.site
     {green}──────────────────────────────────────────────────────────────────────\033[0m
     {red}OWNER     {white}: {yellow} GOJO  
...
file_names = ["FRAACCOUNT.txt", "FRAPAGES.txt", "RPWACCOUNT.txt", "RPWPAGES.txt", "LIKESLOW.txt", "SHARES.txt", "LOWQUALITY.txt", "generated_code.txt"]
...
def share_in_threads(link, file_path, num_shares):
    ...
    print(f"    {blue}───────────────────────────────────────────────────────────────\033[0m")
    print(f"\n {yellow} ✅SHARING STARTED AT: {time.ctime(start_all)}")
    print(f"  {yellow} ⏳SHARING ENDED AT: {time.ctime(end_all)}")
    print(f"  {yellow} ⏱️TOTAL DURATION: {end_all - start_all:.2f} seconds")   
def count_tokens(accounts_file, pages_file):
    """Count the number of accounts and pages stored in the respective files."""
    total_accounts = 0
    total_pages = 0
...
{red}│               | |_\ \ \ \_/ / /\__/ / \ \_/ /
{G}│                \__/  \_/  \__/   \_/                                                   |
{R}│                  {green}   UPDATED BOOSTING TOOL                  {green}          │
{green}╰──────────────────────────────────────────────────────────────────────╯
{B}┌─── {G}❏ {Y}❏ ───────T O O L   I N F O R M A T I O N S{B}───────────────────┐
...
{B}│                                               {red}    version {G}3.0   {white} {B} │
{B}└───────────────────────────────────────────────────── {G}❏ {Y}❏──────────┘

 {B}┌──{red}[ {green}AUTHOR/OWNER{R} ]
 {B}╰────── {green}❯{Y}❯{purple}❯{white}❯ {Y}  G O J O """)
...
def pub():
    ...
    print(f"""                 {blue}OVERVIEW OF STORED ACCOUNT & PAGES💫
                          ...
                          {G}  │ {red}FRA ACCOUNT{yellow} : {green}{total_accounts} {B}│ 
                          {G}  │ {red}FRA PAGES  {yellow} : {green}{total_pages}     {B}│ 
                          {G}  │ {red}RPW ACCOUNT{yellow} : {green}{ rpw_accounts}{B}│ 
                          {G}  │ {blue}RPW PAGES  {yellow} : {green}{rpw_pages}     {B}│ 
{yellow}───────────────────────────────────────────────────────────────\033[0m[0m""")
    print(f"     {blue}[1] {yellow}EXTRACT ACCOUNT")
    print(f"     {blue}[2] {yellow}AUTO SHARE ")
    print(f"    {blue}───────────────────────────────────────────────────────────────\033[0m")
...
def main():
    ...
    print(f"""                 {lightblue}OVERVIEW OF STORED ACCOUNT & PAGES💫
                {B}        │ {G} FRA ACCOUNT {R}: {green}{total_accounts}   │
                {B}        │ {G} FRA PAGES   {R}: {green}{total_pages}   │
                {B}        │ {G} RPA ACCOUNT {R}: {green}{total_account_rpw}  │
                {B}        │{G}  RPA PAGES   {R}: {green}{total_pages_rpw}   │                                                                       
{hotpink}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m""")
    print(f"{hotpink}┃                 {light_magenta} 𝗦 𝗜 𝗠 𝗣 𝗟 𝗘     𝗧 𝗢 𝗢 𝗟 𝗦                         {hotpink}      ┃")
    print(f"{hotpink}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛ ")
    print(f"{hotpink}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓")
    print(f"{hotpink}┃  {green}[01] {red}❯ 𝐒𝐓𝐀𝐑𝐓 𝐓𝐎𝐎𝐋𝐒                         {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {green}[02] {red}❯ 𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐏𝐎𝐒𝐓                     {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {green}[03] {red}❯ 𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐑𝐄𝐄𝐋𝐒                    {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {hotpink}  ┃")
    print(f"{hotpink}┃  {green}[04] {red}❯ 𝐀𝐔𝐓𝐎 𝐑𝐄𝐏𝐋𝐘 𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                 {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[05] {red}❯ 𝐀𝐔𝐓𝐎 𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                       {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[06] {red}❯ 𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                 {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[07] {red}❯ 𝐀𝐔𝐓𝐎 𝐂𝐎𝐌𝐌𝐄𝐍𝐓 𝐋𝐈𝐕𝐄 𝐒𝐓𝐑𝐄𝐀𝐌            {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")        
    print(f'''{B}  ━━━━━━━━━━━━━━━━━━{Y} 𝗔 𝗖 𝗖 𝗢 𝗨 𝗡 𝗧   𝗦 𝗘 𝗥 𝗩 𝗜 𝗖 𝗘 𝗦  {B}━━━━━━━━━━━━━━━━━━━━''')           
    print(f"{hotpink}┃  {green}[08]{red}  𝐑𝐄𝐒𝐄𝐓 𝐓𝐎𝐎𝐋𝐒                          {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {green}[09] {red} 𝐑𝐄𝐌𝐎𝐕𝐄 𝐃𝐔𝐏𝐋𝐈𝐂𝐀𝐓𝐄                     {yellow}- {green}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐑𝐎𝐌𝐎𝐕𝐄𝐑 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {green}[10]  {red}𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑                      {yellow}- {green}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 ]  {hotpink}      ┃")
    print(f"{hotpink}┃  {green}[11]  {red}𝐕𝐀𝐋𝐈𝐃𝐀𝐓𝐄 𝐓𝐎𝐊𝐄𝐍                       {yellow}- {green}[ 𝐓𝐎𝐊𝐄𝐍 ]             {hotpink}     ┃")
    print(f"{hotpink}┃  {green}[12]  {red}𝐑𝐄𝐃𝐄𝐄𝐌 𝐀𝐂𝐂𝐎𝐔𝐍𝐓                       {yellow}- {green}[ 𝐑𝐄𝐃𝐄𝐌𝐓𝐈𝐎𝐍𝐒 ]      {hotpink}       ┃") 
    print(f'''{B} ━━━━━━━━━━━━━━━━━━{Y} 𝗦 𝗛 𝗔 𝗥 𝗘   𝗦 𝗘 𝗥 𝗩 𝗜 𝗖 𝗘 S{B} ━━━━━━━━━━━━━━━━━━━━━━━━━━━━''')    
    print(f"{hotpink}┃  {green}[13]  {red}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄 𝐕1                        {yellow}- {green}[ 𝐅𝐀𝐒𝐓 𝐒𝐏𝐄𝐄𝐃 / 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ] {hotpink}  ┃") 
    print(f"{hotpink}┃  {green}[14]  {red}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄 𝐕2                        {yellow}- {green}[ 𝐅𝐀𝐒𝐓 𝐒𝐏𝐄𝐄𝐃 / 𝐏𝐔𝐁𝐋𝐈𝐂 ]   {hotpink} ┃")     
